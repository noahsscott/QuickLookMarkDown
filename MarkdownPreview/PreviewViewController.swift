...
class PreviewViewController: NSViewController, QLPreviewingController {
    ...
    // Highlight.js v11.9.0 - Syntax highlighting library
    // License: BSD-3-Clause - https://github.com/highlightjs/highlight.js/blob/main/LICENSE
    // Includes common languages: bash, c, cpp, csharp, css, go, java, javascript, json, php, python, ruby, rust, sql, swift, typescript, xml, yaml, and more
