...
A modern macOS Quick Look extension for rendering markdown files with beautiful Apple Human Interface Guidelines styling, syntax highlighting, and GitHub-flavored emoji support.
